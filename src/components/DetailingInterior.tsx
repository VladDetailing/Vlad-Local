      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Detailing <span className="text-blue-500">Interior</span>
          </h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Redescoperă plăcerea de a conduce într-un interior impecabil.
            Alege pachetul care se potrivește nevoilor tale.
          </p>
        </div>
      ...
      <div className="mt-24 pt-12 border-t border-gray-900">
        ...
        <div className="flex flex-nowrap overflow-x-auto overscroll-x-contain gap-3 text-xs text-gray-700 w-full max-w-full snap-x">
          {[
            ...
            'Igienizare interior auto',
            'Curățare tapițerie auto',
            'Curățare piele auto',
            'Ozonizare auto Galați',
            'Detailing interior premium',
            'Curățare plafon auto',
